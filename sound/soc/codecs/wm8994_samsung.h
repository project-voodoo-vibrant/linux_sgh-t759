...
#if defined(CONFIG_S5PC110_HAWK_BOARD)
#define RECORDING_QIK_SPK	(0x01 << 13)
#define RECORDING_QIK_HP	(0x01 << 14)
#define RECORDING_GANLITE_MAIN	(0x01 << 15)
#define RECORDING_GANLITE_SPK	(0x01 << 16)
#define RECORDING_GANLITE_HP	(0x01 << 17)
#else
